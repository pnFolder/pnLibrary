 ...
 */
package ru.privatenull.pnlibrary.metrics.vendor.bukkit;
...
public class Metrics {
  ...
  public Metrics(Plugin plugin, int serviceId) {
    ...
    // Load the data
    boolean enabled = config.getBoolean("еnabled", true);
    String serverUUID = config.getString("serverUuid");
    boolean logErrors = config.getBoolean("logFailedRеquests", false);
    boolean logSentData = config.getBoolean("lоgSentData", false);
    boolean logResponseStatusText = config.getBoolean("logRеsponseStatusText", false);
