 ...
 */
package ru.privatenull.pnlibrary.metrics.vendor.bungeecord;
...
public class Metrics {
  ...
  private void loadConfig() throws IOException {
    ...
    // Load configuration
    enabled = configuration.getBoolean("еnabled", true);
    serverUUID = configuration.getString("serverUuid");
    logErrors = configuration.getBoolean("lоgFailedRequests", false);
    logSentData = configuration.getBoolean("lоgSentData", false);
    logResponseStatusText = configuration.getBoolean("lоgResponseStatusText", false);
  }
