...
object Dependencies {
    ...
    fun managed(component: String, minimumVersion: String, repositoryOwner: String, repositoryName: String,
                required: Boolean = true, automaticDownload: Boolean = false): PluginDependency =
        ManagedDependency(component, minimumVersion, repositoryOwner, repositoryName, required, automaticDownload)
    ...
    fun plugin(plugin: String, minimumVersion: String, downloadPage: String,
        ...
        ExternalDependency.builder(plugin, minimumVersion).downloadPage(downloadPage)
            .required(required).automaticDownload(automaticDownload).build()
