...
Локальный отчёт имеет собственный бинарный формат **PN Support Archive** и расширение `.pnsupport`. Обычный текстовый редактор его не открывает: внутри находится зашифрованный диагностический ZIP. Приватный ключ в серверные JAR не входит.
