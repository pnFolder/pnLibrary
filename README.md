...
SHA-256 and embedded metadata, and stage the plan transactionally. Plugin authors configure API,
artifacts and dependencies in the existing `PluginBuilder.updates(...)` registration.
...
Публичный API опубликован в Maven Central. В плагине достаточно объявить:
...
Полное описание единого builder API, Java-примеров, условий, фильтров и нативных адаптеров находится в [docs/TASKS.md](docs/TASKS.md).
